            ...
            <div class="row">
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input type="text" id="editarnombre" name="editarnombre" class="form-control" placeholder="Nombre Completo" value="<?php echo $usuario['nombre'] ?>" required>
                ...
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input type="email" name="editaremail" id="editaremail" class="form-control" placeholder="Correo Electronico" value="<?php echo $usuario['email'] ?>" required>
                    </div>
                </div>
            </div>
            <div class="row">
